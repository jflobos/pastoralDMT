	...
	$(function(){
	  ...
	  $("#genero_acordion").click(function () {        
	        ...
	        if(char1==0)
	        {
	          ...
	          $.get('../../AjaxEstadisticaGrupoGenero', { grupo_id: grupo},
	              function(data){
	    ...
	    $("#necesidad_acordion").click(function () {  
	        ...
	        {
	          var grupo = $('#grupoId').val();
	          $.get('../../AjaxEstadisticaGrupoNecesidades', { grupo_id: grupo},
	              function(data){
	                  data = jQuery.parseJSON(data);
	    ...
	    $("#experiencia_acordion").click(function () {  
	        ...
	        {
	          var grupo = $('#grupoId').val();
	          $.get('../../AjaxEstadisticaGrupoExperiencia', { grupo_id: grupo},
	              function(data){
	                  data = jQuery.parseJSON(data);
	    ...
	    $("#edades_acordion").click(function () {  
	        ...
	        {
	          var grupo = $('#grupoId').val();
	          $.get('../../AjaxEstadisticaGrupoEdades', { grupo_id: grupo},
	              function(data){
	                  data = jQuery.parseJSON(data);
	     ...
	     $("#movimientos_religiosos_acordion").click(function () {  
	        ...
	        {
	          var grupo = $('#grupoId').val();
	          $.get('../../AjaxEstadisticaGrupoMovimiento', { grupo_id: grupo},
	              function(data){  
	                  data = jQuery.parseJSON(data);
	    ...
	    $("#carreras_acordion").click(function () {  
	        ...
	        {
	          var grupo = $('#grupoId').val();
	          $.get('../../AjaxEstadisticaGrupoCarrera', { grupo_id: grupo},
	              function(data){
	                  data = jQuery.parseJSON(data);
