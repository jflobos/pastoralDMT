 ...
 */
class PastoralProyectoVersion extends BasePastoralProyectoVersion
{
	// public function getActivos()
	// {
		// $q = Doctrine_Query::create()
      // ->from('ProyectoVersion a')
      // ->where('a.active = ?', true);
	// }
  public function __toString()
  {
    
    $proyecto = Doctrine_Core::getTable('PastoralProyecto') ->getNombreProyectoPorId($this->getProyectoId());
    
    return sprintf('%s - %s ', $proyecto, $this->getVersion());
