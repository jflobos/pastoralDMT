...
<div>    
    ...
    <!-- Acordion con el equipo de zona -->    
    
    <div class="accordion" id="infoEquipo">
        <div class="accordion-group">
            <div class="accordion-heading">
                <a class="accordion-toggle" data-toggle="collapse" data-parent="#infoEquipo" href="#equipo">
                    <h5><i class="icon-chevron-down"></i>Equipo de Zona</h5>
                </a>
            </div>
            <div id="equipo" class="accordion-body collapse">
                <div class="accordion-inner">
                    <table class="table table-bordered table-striped">
                        <thead>
                            <tr>
                        ...
                        <?php foreach ($equipo as $miembro): ?>
                            <tr>
                                <th><?php echo $cargos[$i]['PastoralUsuarioCargo'][0]['PastoralCargo']['nombre']?></th>
                                <td><?php echo $miembro?></td>
                                <td><?php echo $miembro->getEdad()?></td>
                                <td><?php echo $miembro->getEstudios() ?></td>
                                <td><?php echo $miembro->getTelefonoCelular() ?></td>
                                <td><?php echo $miembro->getPastoralMovimiento() ?></td>
                            </tr>
                            <?php $i++?>
                        <?php endforeach; ?>
                        </tbody>
    ...
    <!-- Fin acordion con el equipo de zona -->
    ...
    <div class="accordion" id="infoFiltros">
      ...
      <?php $misioneros = $misioneros ?>
        <?php foreach ($misioneros as $misionero):?>
                    <tr>
